...
function Submit() {
  ...
  return (
    <button type="submit" disabled={pending}
      className="px-5 py-2.5 text-sm font-bold rounded-lg bg-brand-blue hover:bg-blue-800 disabled:opacity-60 text-white transition">
    ...
    <form action={formAction} className="flex flex-col gap-5 max-w-lg">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <select name="provider" defaultValue={provider}
          className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-brand-navy focus:outline-none focus:ring-2 focus:ring-brand-blue bg-white">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input type="password" name="api_key" autoComplete="off" required
          ...
          className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-brand-navy placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-blue" />
        {current?.configured && (
