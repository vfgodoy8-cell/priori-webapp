...
<body style="font-family:sans-serif;background:#F5F5F5;margin:0;padding:32px 16px">
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:16px;border:1px solid #E5E7EB;padding:40px 36px">
    ...
    <h1 style="font-size:20px;font-weight:700;color:#0D2240;margin:0 0 8px">Invitación al equipo</h1>
    <p style="font-size:14px;color:#5C6B7A;margin:0 0 24px">
      ${byLine} unirte a <b style="color:#0D2240">${orgName}</b> como
      <b style="color:#0D2240">${roleLabel}</b>.
    </p>
    ...
    <p style="font-size:11px;color:#1E56C4;word-break:break-all;margin:0 0 24px">${inviteUrl}</p>
