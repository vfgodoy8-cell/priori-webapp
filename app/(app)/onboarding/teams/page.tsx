...
const inp = "w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-brand-navy placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:border-transparent bg-white";
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="flex flex-col items-center mb-8 gap-3">
          ...
          <span className="text-2xl font-bold text-brand-navy tracking-tight">priori</span>
        </div>
        ...
        <div className="flex items-center gap-2 mb-5 justify-center">
          ...
          <div className="flex items-center gap-1.5">
            <div className="w-6 h-6 rounded-full bg-brand-blue text-white text-xs font-bold flex items-center justify-center">2</div>
            <span className="text-xs font-medium text-brand-blue">Equipos</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="flex flex-col gap-5">
            ...
            <button
              type="button"
              onClick={addDraft}
              className="text-sm text-brand-blue hover:text-blue-800 font-semibold py-1.5 border border-dashed border-brand-blue rounded-lg hover:bg-blue-50 transition"
            >
              + Agregar equipo
            </button>
            ...
            <div className="flex flex-col gap-2 pt-1">
              ...
              <button
                ...
                className="w-full text-sm text-brand-gray hover:text-brand-navy py-2 transition"
              >
